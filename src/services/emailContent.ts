let randomPassEmail = (pass: string) => `<!doctype html>
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	*/
    ...
    <body>
		<!--*|IF:MC_PREVIEW_TEXT|*-->
		<!--[if !gte mso 9]><!----><span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">Your New Password</span><!--<![endif]-->
		<!--*|END:IF|*-->
        <center>
							...
							<tr>
								<td align="center" valign="top" id="templateHeader">
									...
									<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer">
										<tr>
                                			<td valign="top" class="headerContainer"><table class="mcnBoxedTextBlock" style="min-width:100%;" width="100%" cellspacing="0" cellpadding="0" border="0">
    <!--[if gte mso 9]>
                            ...
                            <table class="mcnTextContentContainer" style="min-width: 100% !important;background-color: #404040;" width="100%" cellspacing="0" border="0">
                                <tbody><tr>
                                    <td class="mcnTextContent" style="padding: 18px;color: #F2F2F2;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: center;" valign="top">
                                        <span style="font-size:25px"><span style="font-family:lucida sans unicode,lucida grande,sans-serif">SUBSCRIPTION ALERT APP</span></span>
                                    </td>
                                </tr>
                            </tbody></table>
                        </td>
                ...
                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                    <tbody><tr>
                        ...
                        <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                            ...
                            <h3>Hello,</h3>
<br>
As per requested by you we have generated a new secure password for your account. Please use this password to login and you can change it afterwards
<div style="text-align: center;"><br>
<span style="font-size:32px"><span style="font-family:arvo,courier,georgia,serif">${pass}</span></span></div>
                ...
                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                    <tbody><tr>
                        ...
                        <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                            ...
                            <em>Copyright © ${new Date().getFullYear()} Cybertron Technologies, All rights reserved.</em><br>
<br>
<strong>Our mailing address is:</strong><br>
simarpreet@cybertrontechnologies.com<br>
<br>
Want to change how you receive these emails?<br>
You can update your preferences in app settings.
                        </td>
                    </tr>
                </tbody></table>
				<!--[if mso]>
